...
class BinarySearchTree 
{
    struct Node 
    {
        ...
        void output_node_tree(size_t prefix) const;
...
public:
    ...
    **************************************************************/
    ...
    void output_tree();
    friend bool deleteEmptyNode(Node* root);
    friend void createEmptyNode(Node* root);
    friend void reCopy(Node* node, Node* otherNode);
    friend void deBST(Node* node);
